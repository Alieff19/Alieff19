...
### 🛠️ Tech Stack & Tools
Saya berfokus pada kualitas pemahaman dibanding kuantitas. Berikut adalah teknologi yang sering saya gunakan:
...
### 💻 Featured Projects
Berikut adalah beberapa proyek unggulan yang sedang atau telah saya kerjakan:
...
| **Secure QR Generator** | Web app generator QR Code yang mengintegrasikan keamanan data. | Python, Flask |
| **High-Availability App** | Implementasi arsitektur skalabel menggunakan Docker Container dan Load Balancer. | Docker, Nginx, Web App |
